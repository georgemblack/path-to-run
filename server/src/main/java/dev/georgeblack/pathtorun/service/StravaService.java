...
public class StravaService {
  ...
  public StravaSegments getSegmentsInRegion(Region region) {
    ...
    UriComponentsBuilder uriBuilder =
        UriComponentsBuilder.fromHttpUrl(segmentsEndpoint)
    ...
    ResponseEntity<StravaSegments> response =
        restTemplate.exchange(
            uriBuilder.toUriString(), HttpMethod.GET, request, StravaSegments.class);
  ...
  public void refreshAccessToken() {
    ...
    ResponseEntity<StravaTokenRefreshResponse> response =
        restTemplate.exchange(
            refreshEndpoint, HttpMethod.POST, request, StravaTokenRefreshResponse.class);
